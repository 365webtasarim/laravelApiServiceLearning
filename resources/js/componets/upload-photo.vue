                    ...
                    <template v-for="(image, index) in images" :key="index" #item="{element}">
                       <figure>
                          ...
                          <div class="actions">
                              ...
                              <i class="delete fas fa-trash" @click="images.splice(index, 1)"></i>
                          </div>
                      </figure>
                    </template>
                </draggable>
...
export default {
    ...
    data: () => {
        return {
            ...
            {
                src:
                    "https://profdrhaydarbasenstitusu.org/image/enstitu-slider.jpg",
                title: "map-shots/xxbu8zaflm5qdwawurbb",
            },
            {
                src:
                    "https://profdrhaydarbasenstitusu.org/image/slider1.jpg",
                title: "metal_ehet1g",
            },
