        ...
        <div class="col-lg-3 col-sm-12 col-12">
            <div class="upload-area" v-if="!editArea">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" readonly :value="selectedFiles.length + ' Resim Seçildi'">
                </div>
                <a class="btn btn-success pull-right mt-10" @click="store()" :disabled="selectedFiles.length == 0">Yükle</a>
            ...
            <div class="preview-area">
                ...
                <figure v-if="results">
                    ...
                    <div class="actions">
                        ...
                        <i class="show fa fa-eye" :href="images" :data-fancybox="prefix"></i>
                        <i class="delete fas fa-trash-alt" @click="images=null"></i>
                    </div>
                </figure>

                <h4 v-if="images==null" class="no-media">Lütfen Kapak Fotoğrafı Yükleyiniz</h4>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            title: {type: String,required: false,default: () => {return "Resim Yükleme"}} ,
            btnText: {type: String,required: false,default: () => {return "Gözat"}} ,
            help: {type: String,required: false,default: () => {return ""}} ,
            old: {type: String,required: false,default: () => {return null}},
        ...
        methods: {
            ...
            store(){
                ...
                if(vm.selectedFiles.length==0){
                    toast.info('Lütfen Fotoğraf Yükleyiniz.');
                    return;
                }
