        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('koseyazilari')" :active="request()->routeIs('koseyazilari')">
                        {{ __('Köşe Yazıları') }}
                    </x-nav-link>
                    <x-nav-link :href="route('sohbetler')" :active="request()->routeIs('sohbetler')">
                        {{ __('Sohbetler') }}
                    </x-nav-link>
...
{{--                    </x-nav-link>--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('koseyazilari')" :active="request()->routeIs('koseyazilari')">
                {{ __('Köşe Yazıları') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('sohbetler')" :active="request()->routeIs('sohbetler')">
                {{ __('Sohbetler') }}
            </x-responsive-nav-link>
