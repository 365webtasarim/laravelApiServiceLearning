        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200 d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{route('VideoCreate')}}" class="btn btn-success">
                        Yeni Oluştur
                    </a>
                </div>
                    ...
                    <table class="table table-striped table-hover" id="makaleler">
                        ...
                        @foreach($makaleler as $makale)
                            <tr>
                                ...
                                <th>{{$makale->hit}}</th>
                                <td>
                                    <a class="btn btn-info btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Düzenle" href="/videolar/{{$makale->slug}}">
                                        <i class="fas fa-share"></i>
                                    </a>
                                    <a class="btn btn-success btn-xs tooltips" data-container="body" data-placement="top" data-original-title="Düzenle" href="videolar/edit/{{$makale->id}}">
