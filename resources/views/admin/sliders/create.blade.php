        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Makale Oluşturma</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form id="app" method="POST" action="{{route('makaleCreatePost')}}">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="embed" class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " value="">
